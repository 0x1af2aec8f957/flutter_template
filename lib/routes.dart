...
import './views/SmallProgramTest.dart';

final routes = <String, WidgetBuilder>{ //
  '/': (BuildContext context) => Home(title: '首页'),
  'about': (BuildContext context) => About(title: '关于', arg: ModalRoute.of(context).settings.arguments),
  'example': (BuildContext context) => Example(title: '示例程序'),
  'webview': (BuildContext context) => Browser(title: 'webview', url: 'https://www.baidu.com'),
  ...
  'smallProgramTest': (BuildContext context) => SmallProgramTest(title: '测试'),
};
