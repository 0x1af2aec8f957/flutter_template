...
abstract class CustomTheme {
  static ThemeData light = ThemeData( // 深色
    ...
    accentColor: Colors.white, // 小部件的前景色(旋钮、文本、覆盖边缘效果等)。
    accentColorBrightness: Brightness.light, // accentColor的亮度。
    ...
    textSelectionColor: Colors.black, // 文本框中文本选择的颜色，如TextField
    cursorColor: Colors.black, // 文本框中光标的颜色，如TextField
    textSelectionHandleColor: Colors.black,  // 用于调整当前选定的文本部分的句柄的颜色。
    ...
    appBarTheme: AppBarTheme(
      ...
      textTheme: TextTheme(title: TextStyle(fontSize: 18, color: const Color(0xFF41414c), fontWeight: FontWeight.w500)),
