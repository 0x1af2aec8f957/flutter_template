abstract class DateFormat {
  static DateTime toDateTime([String _formattedString = '0']){
    return DateTime.fromMillisecondsSinceEpoch(int.parse(_formattedString));
  }

  static DateTime toDate ([int _millisecondsSinceEpoch = 0]){
  ...
  static int toMillisecondsSinceEpoch(String? _formattedString){
    final DateTime date = toDateTime(_formattedString ?? '0');
